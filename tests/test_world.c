...
Test(world, add_component_size_registers_component) {
    ...
    ecs_set_component_meta(world, comp, sizeof(Position));
...
Test(world, insert_stores_and_retrieves_data) {
    ...
    ecs_set_component_meta(world, position, sizeof(Position));
...
Test(world, components_sorted_functional) {
    ...
    ecs_set_component_meta(world, compPos, sizeof(Position));
    ecs_set_component_meta(world, compHp,  sizeof(Health));
...
Test(world, remove_component_get_other) {
    ...
    ecs_set_component_meta(world, position, sizeof(Position));
    ecs_set_component_meta(world, health, sizeof(Health));
    ...
    Health *read_health = ecs_get(world, player, health);
...
Test(relation, wildcard) {
    ...
    cr_assert(ecs_has(world, player, ecs_make_pair(ecs_id(EcsChildOf), ecs_id(MainScene))));
    cr_assert(ecs_has(world, player, ecs_make_pair(ecs_id(EcsChildOf), ecs_id(EcsWildcard))));

    ecs_remove_pair(world, player, ecs_id(EcsChildOf), ecs_id(MainScene));
